...
numFailures += compareToReference(referenceFile,outputFile,'max_d_before_singularity',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
numFailures += compareToReference(referenceFile,outputFile,'volume_magnetization',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
...
numFailures += compareToReference(referenceFile,outputFile,'d',absoluteTolerance=absoluteTolerance,relativeTolerance=relativeTolerance)
